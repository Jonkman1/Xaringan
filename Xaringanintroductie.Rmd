...
Om mij dit goed eigen te maken heb ik de post van Fabio Votta (7 augustus 2018) en de presentatie van Yihui Xie vertaald. Het lijkt simpel, maar voor mij is dit een goede manier om het eigen te maken. Nadat ik dit heb gedaan, heb ik er zelf enkele zaken aan toegevoegd die ik handig vind of die nieuw zijn.
...
![](G:/Xaringgan/screenshots/yaml.png)

Dat geeft het volgende resultaat:

![](G:/Xaringgan/screenshots/voorbeeld.png)
...
![](G:/Xaringgan/screenshots/Slide3.png)
...
![](G:/Xaringgan/screenshots/Slide4.png)
...
![](G:/Xaringgan/screenshots/Slide5.png)
